document.addEventListener('DOMContentLoaded', () => {
    ...
    function convertCurrency() {
        ...
        localStorage.setItem('lastConversion', JSON.stringify({ amount, fromCurrency, toCurrency, result }));
    }
    ...
    if (lastConversion) {
        document.getElementById('result').innerText = `${lastConversion.amount} ${lastConversion.fromCurrency} = ${lastConversion.result.toFixed(2)} ${lastConversion.toCurrency}`;
    }
});
